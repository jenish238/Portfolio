          ...
          >
            ...
            <article style={{ flex: "1 1 450px" }}>
              ...
              >
                <p style={{ marginBottom: "25px" }}>
                  ...
                  <strong>
                    Healthcare, Finance, Construction, and Renewable Energy
                  </strong>
                  .
                </p>
                <p style={{ marginBottom: "25px" }}>
                  Currently, I am at the forefront of the{" "}
                  <strong>AI-First CRM</strong> era. I specialize in integrating
                  autonomous agents and <strong>Agentforce</strong> capabilities
                  with <strong>Gemini AI</strong> to create next-generation
                  workflows that are not just automated, but truly intelligent.
                </p>
                <p>
                  As a <strong>6× Certified Salesforce Expert</strong>, I bridge
                  the gap between business vision and technical execution,
                  ensuring that every line of code adds measurable value.
                </p>
              </div>
            </article>
            ...
            <div style={{ flex: "1 1 320px" }}>
              ...
              >
                ...
                >
                  "Technical leadership is not about knowing all the answers,
                  but about building systems that consistently find them."
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          {[
            ...
            {
              href: "https://www.salesforce.com/trailblazer/jgangani1",
              icon: <FaSalesforce />,
              label: "Trailhead",
            },
            {
            ...
            <a
              ...
              rel={href.startsWith("mailto") ? "noreferrer" : "me noreferrer"}
              style={{ color: "var(--white)", fontSize: "1.5rem" }}
        ...
        >
          Built with ❤️ by Jenish Gangani &copy; 2026
        </p>
      </footer>
    </main>
  );
