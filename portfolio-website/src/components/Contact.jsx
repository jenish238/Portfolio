  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/jenishgangani238@gmail.com",
        {
          method: "POST",
    ...
    >
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          >
            I'm always open to discussing Salesforce projects, AI integrations,
        ...
        >
          ...
          >
            {[
              ...
              },
              {
                icon: <FaEnvelopeOpen />,
                title: "Email",
                text: "jenishgangani238@gmail.com",
          ...
          {/* Right: Contact Form */}
          <div
            className="fade-in stagger-4 glass"
            style={{
              flex: "1 1 480px",
              padding: "40px",
              borderRadius: "16px",
            ...
            {status === "success" ? (
              ...
              >
                ...
                >
                  ...
                  <strong style={{ color: "var(--white)" }}>24 hours</strong>.
                </p>
                <button
