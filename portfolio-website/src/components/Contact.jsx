      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="contact-wrapper" style={{ 
          ...
          <div className="fade-in stagger-4 glass" style={{ flex: '1 1 500px', padding: '40px', borderRadius: '16px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
            ...
            {status === 'success' ? (
              <div className="fade-in" style={{ textAlign: 'center', padding: '40px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px', height: '100%', justifyContent: 'center' }}>
                <FaCheckCircle style={{ fontSize: '4rem', color: 'var(--primary)' }} />
